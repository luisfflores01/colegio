...
SECRET_KEY = 'django-insecure-j!9b^%w2j8h38zfhd4j&5^fx@3lnruiiq_h3%&ihjc=$e-tad2'
...
INSTALLED_APPS = APPS_BASE + APPS_LOCAL + APPS_THRIDS
...
MATERIAL_ADMIN_SITE = {
    'HEADER': 'UNIDAD EDUCATIVA PRIMAVERA',  # Admin site header
    'TITLE':  'U.E. PRIMAVERA',  # Admin site title
    'FAVICON':  'media/img/favicon.ico',  # Admin site favicon (path to static should be specified)
